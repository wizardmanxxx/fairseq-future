...
class FutureLabelSmoothedCrossEntropyCriterion(FairseqCriterion):
    ...
    def __init__(self, task, sentence_avg, label_smoothing, future_loss_lambda):
        super().__init__(task)
        self.sentence_avg = sentence_avg
        self.eps = label_smoothing
        self.future_lambda = future_loss_lambda
    ...
    def compute_loss(self, model, net_output, sample, reduce=True):
        ...
        lp = utils.log_softmax(net_output[1]['future_word'], dim=2)
