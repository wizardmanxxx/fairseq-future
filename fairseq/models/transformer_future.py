...
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def forward(self, src_tokens, src_lengths, prev_output_tokens, cls_input: Optional[Tensor] = None,
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def forward(self, prev_output_tokens, encoder_out: Optional[EncoderOut] = None,
        ...
        return x, {'future_word': fi_word, 'attn': extra}
    ...
    def reorder_incremental_state(self, incremental_state, new_order):
        ...
        prev_F = utils.get_incremental_state(
            self, incremental_state, 'prev_F',
        )
        # Reorder batches according to *new_order*.
        prev_F = prev_F.index_select(0, new_order)
        # Update the cached state.
        utils.set_incremental_state(
            self, incremental_state, 'prev_F', prev_F,
        )
